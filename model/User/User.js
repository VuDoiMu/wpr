...
const handleRegister = async (userName, email, password) => {
  ...
  const [_rows] = await db
    .promise()
    .query(insertSql, [userName, email, password]);
...
const getUserByIDNoPassword = async (userID) => {
...
const getUserByEmailNoPassword = async (email) => {
...
const getAllUsersNoPassword = async (currentID) => {
  const [rows] = await db
    .promise()
...
const getUsersByListIDs = async (ids) => {
